function computeForm(form){
    ...
    function amortize(form) {
         ...
         var mr1=pow((parseFloat(1)+parseFloat(mr)),tm);
               ...
               tempAmortStr += "<span id='span_1'>Results:</span>";
               ...
               tempAmortStr += "\n<div align='center'>";
         		tempAmortStr += "\n<table width='335' border='0' cellpadding='5' cellspacing='0' style='font-family: arial;font-size:12px;'>";
				   tempAmortStr += "\n<tr><td bgcolor='#A72614' align='center'><b>Payment Number</b></td>";
               tempAmortStr += "<td bgcolor='#A72614' align='center'><b>Payment Amount</b></td><td bgcolor='#A72614' align='center'><b>Interest Amount</b></td>";
               tempAmortStr += "<td bgcolor='#A72614' align='center'><b>Principle Reduction</b></td><td bgcolor='#A72614'><b>Balance Due</b></td></tr>";
               for (var j=1; j<=tm; j++)
               {
                                 m2=""+j;
                                 int1=amt1*(r/100);
                 ...
                 tempAmortStr += "\n<tr><td bgcolor='#326484'>"+m2+"</td>";
                 tempAmortStr += "<td bgcolor='#326484' align='center'>"+p2+"</td>";
                 tempAmortStr += "<td bgcolor='#326484' align='center'>"+int2+"</td>";
                 tempAmortStr += "<td bgcolor='#326484' align='center'>"+amt2+"</td>";
                 tempAmortStr += "<td bgcolor='#326484' align='center'>"+q2+"</td></tr>\n";
                                 amt1=q;
               }
